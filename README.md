# Compatibility test DP Configurations

This repository contains all the configuration resources required for the Compatibility test DP project to function properly and expose its business features.
